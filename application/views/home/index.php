<section class="py-5 text-center container-fluid home-section1">
    ...
    <div class="col-lg-4 col-md-4">
      ...
      Forced land concessions and acquisitions in Indonesia and Thailand driven by corruption has resulted in loss of local wisdom, biodiversity, 
      and rights violations especially affecting marginalised and vulnerable populations.
...
<section class="container-fluid home-section9">
	<div class="row py-lg-5">
      ...
      <a href="https://www.facebook.com/landdefender13" target="_blank">
      ...
      <a href="https://www.instagram.com/landdefender13" target="_blank">
      ...
      <a href="https://x.com/TheLandDefender" target="_blank">
      ...
      <a href="https://www.linkedin.com/in/the-land-defender-681a89323" target="_blank">
    ...
    <div class="col-lg-8 col-md-12 mx-auto">
      ...
      <div class="text-end">
          <?php
        if(!empty($banner1->data)){
				foreach (@$banner1->data as $row) {
					$link =  $row->banner_link;
          $thumb = str_replace('//land-bn/','//localhost:8011/',$row->thumb);
				?>
        <a href="<?php echo $link?>" target="_blank"><img src="<?php echo $thumb?>" width="80" alt="" class="ml-5"></a>
        <?php }}?>
        <br />
        <?php
        if(!empty($banner1->data)){
          ...
          $thumb = str_replace('//land-bn/','//localhost:8011/',$row->thumb);
				?>
        <a href="<?php echo $link?>" target="_blank"><img src="<?php echo $thumb?>" width="110" alt=""></a>
        <?php }}?>
      </div>
		</div>
