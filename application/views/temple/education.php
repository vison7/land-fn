...
<div data-delay="4000" data-animation="slide" class="slide-full w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="3" data-duration="500" data-infinite="true">
  ...
  <div class="wat-container w-container">
    ...
    <h1 class="heading-3">วัดกรณีศึกษา</h1>
    <p class="paragraph-8">วัดที่เกิดการเปลี่ยนแปลงอย่างเป็นรูปธรรม โดยมีโจทย์ ประเด็นการทำงานที่มีการถอดองค์ความรู้ร่วมกับโครงการฯ อย่างเป็นระบบ เพื่อให้วัดอื่นๆ สามารถร่วมแลกเปลี่ยนเรียนรู้ และนำไปประยุกต์ใช้กับวัดตามบริบทของตัวเองได้ ปัจจุบันกำลังขับเคลื่อวัดกรณีศึกษา 10 แห่ง ได้แก่ วัดกลาง, วัดญาณเวศกวัน, วัดพระธาตุช้างค้ำวรวิหาร, วัดโพธิ์เผือก, วัดภูเขาทอง, วัดวังตะวันตก, วัดสุทธิจิตตาราม, วัดหลวงประชาบูรณะ, วัดอุโมงค์ สวนพุทธธรรม</p><img src="/assets/images/bullet-04_1bullet-04.png" loading="lazy" alt="" class="tp-bullet">
    <div class="w-layout-grid tp-grid1">
      <div>
        <div class="text-block-15"><?php echo $total?></div>
        <div class="text-block-16">วัดกรณีศึกษา</div>
      </div>
    </div>
    ...
    </div><img src="/assets/images/bullet-04_1bullet-04.png" loading="lazy" alt="" class="tp-bullet">
    <div>
